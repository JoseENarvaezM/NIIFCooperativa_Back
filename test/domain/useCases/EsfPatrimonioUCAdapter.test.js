...
const EsfPatrimonioUCAdapter_1 = require("../../../src/domain/useCases/EsfPatrimonioUCAdapter");
describe("EsfPatrimonioUCAdapter", () => {
    let esfPatrimonioUCAdapter;
    let mockEsfPatrimonioGateway;
    ...
    beforeEach(() => {
        ...
        esfPatrimonioUCAdapter = new EsfPatrimonioUCAdapter_1.EsfPatrimonioUCAdapter(mockEsfPatrimonioGateway, mockErrorFormatter);
    });
    describe("getIDForm", () => {
        it("debería retornar el formulario calculado cuando existe", () => __awaiter(void 0, void 0, void 0, function* () {
            // Arrange
            const mockForm = { esfID: "form1" };
            const mockCalculatedForm = { esfID: "form1", calculated: true };
            ...
            // Act
            const result = yield esfPatrimonioUCAdapter.getIDForm("stu1", "room1");
            // Assert
        ...
        it("debería lanzar error cuando el formulario no existe", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Act
            const result = yield esfPatrimonioUCAdapter.getIDForm("stu999", "room999");
            // Assert
    ...
    describe("updateForm", () => {
        it("debería actualizar el formulario correctamente", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Act
            const result = yield esfPatrimonioUCAdapter.updateForm("stu1", "room1", mockForm);
            // Assert
